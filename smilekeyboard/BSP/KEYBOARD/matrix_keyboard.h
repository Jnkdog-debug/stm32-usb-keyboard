...
#define ROW_PIN_0        GPIO_PIN_1// Row 0
#define ROW_PIN_1        GPIO_PIN_2  // Row 1
#define ROW_PIN_2        GPIO_PIN_3   // Row 2

/* Column GPIO Configuration (Input/Sense pins) */
#define COL_PORT         GPIOA
#define COL_PIN_0        GPIO_PIN_4   // Column 0
#define COL_PIN_1        GPIO_PIN_5   // Column 1
#define COL_PIN_2        GPIO_PIN_6   // Column 2
